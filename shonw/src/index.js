          ...
          <div className="parent">
            <div className="d1">
              <p>
                ...
                elit.Officiis commodi dicta molestias corporis tempora, libero
                laudantium, tempore similique eligendi, facilis adipisci iste
                impedit atque pariatur ea!Animi numquam aliquam dolorem.{" "}
              </p>{" "}
              <p>
                Lorem ipsum, dolor sit amet consectetur adipisicing
                elit.Recusandae voluptate quo vitae consequatur alias, odio
                similique voluptatem accusantium, ipsam a totam fuga nesciunt
                nisi in iure maxime ? Facilis, facere dicta!
              </p>{" "}
            </div>{" "}
            <div className="d2">
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing
                elit.Corrupti, voluptas tenetur vitae nostrum ratione pariatur
